...
class ArticlePage extends StatelessWidget {
  ...
  Obx articleItem(Article article, BuildContext context) {
    Seller seller = Get.find<SellerController>()
            .listSeller
            .firstWhereOrNull((p0) => p0.id == article.seller_id) ??
        Seller.initSeller();
          ...
          children: [
            InkWell(
              onTap: () async {
                ...
                await Get.find<SellerController>().getSeller(seller.id);
              },
              child: Row(
                children: [
                  SizedBox(
            ...
            InkWell(
              ...
              child: SizedBox(
                ...
                child: Text(
                  article.content,
                  overflow:
                      isShow.value ? TextOverflow.clip : TextOverflow.ellipsis,
            ...
            listArticleImage.isEmpty
                ...
                : Row(
                    ...
                    children: listArticleImage.asMap().entries.map((entry) {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: (Theme.of(context).brightness ==
                                      ...
                                      ? Colors.white
                                      : Colors.black)
                                  .withOpacity(currentImg.value == entry.key
                                      ? 0.9
                                      : 0.4)),
                        ),
                      );
  ...
  void loadData(RxList<Article> listArticle) {
    listArticle.value = Get.find<ArticleController>().listArticle;
  }
}
